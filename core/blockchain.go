...
func (bc *BlockChain) insertChain(chain types.Blocks, setHead bool) (int, error) {
	...
	for ; block != nil && err == nil || errors.Is(err, ErrKnownBlock); block, err = it.next() {
		...
		accountTrieUpdateTimer.Update(timers.AccountTrieUpdates)
		accountTrieUpdateInnerTimer.Update(timers.AccountTrieUpdateInner)
		accountOriginUpdateTimer.Update(timers.AccountOriginUpdates)
